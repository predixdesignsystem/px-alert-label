...
function runBaseTests() {
  fixture = document.getElementById('fixture-important');

  suite('Base Automation Tests for px-alert-label', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-alert-label fixture is created', function() {
      assert.isTrue(document.getElementById('fixture-important') !== null);
    });
